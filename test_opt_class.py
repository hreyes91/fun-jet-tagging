...
data_path_1='/net/data_ttk/hreyes/JetClass/OptClass/OptimalClassifierSamplesSameBinGen/top/discretized/samples_samples_noseed_nsamples200000_trunc_5000_0.h5'


data_path_2='/net/data_ttk/hreyes/JetClass/OptClass/OptimalClassifierSamplesSameBinGen/qcd/discretized/samples_samples_noseed_nsamples200000_trunc_5000_0.h5'
...
for model_path in models_paths:
    ...
    full_path=main_models_path+'/'+main_path
